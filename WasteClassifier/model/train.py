...
def main():
    ...
    train_loader, test_loader = read_to_loader(config.batch_size)
    model = Model.ConvolutionalNetwork()
    ...
    train(train_loader, test_loader, criterion, optimizer, config.epochs, count_time=True)
